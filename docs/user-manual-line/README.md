...
2. **ภาพขั้นตอนฝั่ง LINE** (`00a`, `00b`, `00c`) เป็นภาพ **placeholder** (เพิ่มเพื่อน OA / เปิดลิงก์ / หน้าอนุญาต)
   เนื่องจากถ่ายจากโค้ดไม่ได้ — ให้แทนที่ด้วยภาพหน้าจอจริงจากมือถือ (ชื่อไฟล์เดิม) แล้ว render ใหม่
